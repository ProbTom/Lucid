...
local Functions = {}
pcall(function()
    Functions = require(script.Parent.functions)
end)
...
-- Mode configuration functionality
local function setupModeSection()
...
-- Zone settings functionality
local function setupZoneSection()
